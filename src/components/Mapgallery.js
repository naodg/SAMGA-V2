...
export default function MapGallery() {
    ...
    // }, []);
    return (_jsxs("div", { className: "map-gallery-wrapper", children: [_jsxs("div", { className: "map-gallery-inner", children: [_jsxs("div", { className: "map-gallery-swiper-container", children: [_jsx(Swiper, { className: "map-gallery-swiper", modules: [Navigation, Pagination, Autoplay], navigation: true, pagination: { clickable: true }, autoplay: { delay: 2000, disableOnInteraction: false, }, draggable: true, grabCursor: true, loop: true, children: ['대가1호점', '대가식육식당', '대가한우', '대산식육식당', '대웅식육식당', '미로식육식당', '불난가한우', '삼가명품한우', '상구한우', '태영식육식당'].map((name, i) => (_jsx(SwiperSlide, { children: _jsx("img", { src: `/SAMGA-V2/img/landing/${name}_1.jpg`, alt: name, className: "map-gallery-slide-img" }) }, i))) }), _jsxs("div", { className: "map-gallery-searchbar", children: [_jsx("button", { className: "search-icon-button", onClick: () => {
                                            if (searchQuery.trim() === '') {
