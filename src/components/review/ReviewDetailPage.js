...
export default function ReviewDetailPage() {
    ...
    return (_jsxs("div", { className: "review-detail-page", children: [_jsxs("div", { className: "review-box", children: [_jsxs("div", { className: "review-header", children: [_jsx("h2", { children: store.name }), _jsxs("div", { className: "review-stars", children: [[...Array(5)].map((_, i) => (_jsx("img", { src: review.star >= i + 1
