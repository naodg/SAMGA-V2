...
export default function ReviewDetailPage() {
    ...
    const [editedStar, setEditedStar] = useState(5);
    ...
    return (_jsx("div", { className: "review-detail-page", children: _jsxs("div", { className: "review-box", children: [auth.currentUser?.uid === review.userId && (_jsxs("div", { className: "review-actions", children: [_jsx("img", { src: "/SAMGA-V2/img/icon/\uC218\uC815.svg", alt: "\uC218\uC815", className: "icon-button", onClick: () => {
                                ...
                                setEditedStar(review.star);
                                        ...
                                        : "/SAMGA-V2/img/icon/단골등록.svg", alt: "\uBCC4", className: "star-icon" }, i))), _jsxs("span", { className: "review-star-value", children: [review.star.toFixed(1), "\uC810"] })] })] }), editMode ? (_jsxs("div", { className: "edit-form", children: [_jsx("textarea", { value: editedContent, onChange: (e) => setEditedContent(e.target.value), className: "edit-textarea", placeholder: "\uB9AC\uBDF0 \uB0B4\uC6A9\uC744 \uC218\uC815\uD558\uC138\uC694" }), _jsxs("div", { className: "star-edit", children: [[...Array(5)].map((_, i) => (_jsx("img", { src: editedStar >= i + 1
                                        ? "/SAMGA-V2/img/icon/단골등록해제.svg"
                                        : "/SAMGA-V2/img/icon/단골등록.svg", alt: `${i + 1}점`, className: "star-icon clickable", onClick: () => setEditedStar(i + 1) }, i))), _jsxs("span", { children: [editedStar, "\uC810"] })] }), _jsxs("div", { className: "edit-buttons", children: [_jsx("button", { onClick: handleUpdate, children: "\uC800\uC7A5" }), _jsx("button", { onClick: () => setEditMode(false), children: "\uCDE8\uC18C" })] })] })) : (_jsx("p", { className: "review-content", children: review.content })), _jsxs("div", { className: "review-footer", children: [_jsxs("div", { className: "review-icons", children: [_jsx("img", { src: liked
                                        ? "/SAMGA-V2/img/icon/좋아용누름.svg"
                                        : "/SAMGA-V2/img/icon/좋아용.svg", alt: "\uC88B\uC544\uC694", className: "heart-icon", onClick: toggleLike }), _jsx("span", { children: likeCount }), _jsx("img", { src: comment ? "/SAMGA-V2/img/icon/댓글있음.svg" : "/SAMGA-V2/img/icon/댓글.svg", alt: "\uB313\uAE00" })] }), _jsxs("div", { className: "review-meta", children: ["\uC791\uC131\uC790: ", review.nickname, _jsx("br", {}), review.createdAt?.toDate().toLocaleString()] })] }), comment ? (_jsxs("div", { className: "comment-wrapper", children: [_jsx("img", { src: store.logo, alt: store.name, className: "comment-sticker" }), _jsxs("div", { className: "comment-bubble", children: [auth.currentUser?.uid === comment.userId && (_jsx("div", { className: "comment-actions", children: editCommentMode ? null : (_jsxs(_Fragment, { children: [_jsx("img", { src: "/SAMGA-V2/img/icon/\uC218\uC815.svg", alt: "\uC218\uC815", className: "icon-button", onClick: () => {
