...
export default function StoreDetail() {
    ...
    return (_jsxs("div", { className: "store-detail-wrapper", children: [_jsx("div", { className: "store-hero-image", style: { backgroundImage: `url(${selectedStore.detailimage})` } }), _jsxs("div", { className: "store-info-card", children: [_jsx("img", { src: selectedStore.logo, alt: "\uB85C\uACE0", className: "store-main-logo" }), _jsxs("div", { className: "store-name-stars", children: [_jsx("h2", { className: "store-name", children: selectedStore.name }), _jsxs("div", { className: "star-icons", children: [[...Array(5)].map((_, i) => {
                                    ...
                                    }), _jsxs("span", { style: { marginLeft: '6px', fontSize: '14px', color: '#444' }, children: [average.toFixed(1), "\uC810"] })] })] }), _jsxs("div", { className: "store-detail", children: [_jsx("span", { className: "label", children: "\uC601\uC5C5\uC2DC\uAC04 :" }), " ", selectedStore.hours.split('/')[0], selectedStore.point && (_jsxs("span", { className: "point", children: [" \u203B ", selectedStore.point] }))] }), _jsxs("div", { className: "store-detail", children: [_jsx("span", { className: "label", children: "\uD734\uBB34 :" }), " ", selectedStore.hours.split('/')[1].replace('휴무', '')] }), _jsxs("div", { className: "store-actions", children: [_jsxs("div", { className: "action-item", children: [_jsx("img", { src: "/SAMGA-V2/img/icon/\uAE38\uCC3E\uAE30.svg", alt: "\uAE38\uCC3E\uAE30" }), _jsx("span", { children: "\uAE38\uCC3E\uAE30" })] }), _jsxs("div", { className: "action-item", children: [_jsx("img", { src: "/SAMGA-V2/img/icon/\uACF5\uC720\uD558\uAE30.svg", alt: "\uACF5\uC720\uD558\uAE30" }), _jsx("span", { children: "\uACF5\uC720\uD558\uAE30" })] }), _jsxs("div", { className: "action-item", onClick: handleToggle, children: [_jsx("img", { src: isFavorite
                                        ...
                                        ? '간략히 보기 ▲'
                                        : `+${selectedStore.options.length - 4}개 더보기 ▼` })) })] })] }), _jsxs("div", { className: "store-story-wrapper", children: [_jsx("div", { className: "store-slogan", children: selectedStore.description.split('\n').map((line, i) => (_jsx("div", { children: line }, i))) }), _jsxs("div", { className: "store-name-line", children: [_jsx("span", { className: "store-name-text", children: selectedStore.name }), _jsx("div", { className: "store-name-bar" })] })] }), _jsx("div", { className: "brand-inner", children: _jsxs("div", { className: "store-brand-wrapper", children: [_jsx("img", { src: "/SAMGA-V2/img/logo/videologo.svg", alt: "videologo", className: "video-logo" }), _jsx("div", { className: "brand-text", children: "KOREAN BEEF VILLAGE SAMGA" }), _jsx("hr", { className: "brand-divider" }), !["도원식육식당", "대가한우"].includes(selectedStore.name) && (_jsx("img", { src: selectedStore.logo, alt: "logo", className: "store-sub-logo" }))] }) }), _jsxs("div", { className: "store-detail-images-separated", children: [_jsx("div", { className: "detail-images-pc only-pc", children: selectedStore.detailImagelist
