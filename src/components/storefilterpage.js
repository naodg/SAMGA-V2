...
export default function StoreFilterPage() {
    ...
    return (_jsx("div", { children: isMobile ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "mobile-search-wrapper", children: _jsxs("div", { className: "mobile-search-bar", children: [_jsx("button", { className: "search-icon-button", onClick: () => {
                            ...
                            return (_jsxs("div", { className: "mobile-store-item", onClick: () => navigate(`/store/${encodeURIComponent(store.name)}`), children: [_jsxs("div", { className: "store-item-header", children: [_jsx("img", { src: store.filterimage || '/SAMGA-V2/img/default.jpg', alt: store.name, className: "m-store-thumbnail" }), _jsxs("div", { className: "store-info-text", children: [_jsx("h3", { className: "store-name", children: store.name }), _jsxs("div", { className: "store-stars", children: [[...Array(5)].map((_, i) => {
                                                                const value = i + 1;
                                                                let imgSrc = "";
